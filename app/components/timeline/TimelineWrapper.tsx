...
export const TimelineWrapper = () => {
    ...
    const getBlockBorder = (blockType: string) => {
        const borders = {
            ...
            diamond:
                'border-mc-diamond border-t-cyan-200 border-l-cyan-200 border-b-cyan-600 border-r-cyan-600',
        };
    ...
    const getBlockIcon = (blockType: string, position: string) => {
        ...
        if (
            position.includes('UI/UX Designer') &&
            position.includes('React Developer')
        ) {
            return (
                            ...
                            {experiences.map((exp, index) => (
                                ...
                                >
                                    ...
                                    <div className='shrink-0 relative z-20'>
                                        <div
                                            className={`w-16 h-16 ${getBlockColor(exp.blockType)} minecraft-block border-2 ${getBlockBorder(exp.blockType)} flex items-center justify-center transform hover:scale-110 transition-transform duration-200`}
                                        >
                                            {getBlockIcon(
                                                exp.blockType,
                                                exp.position,
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`flex flex-col md:flex-row ${index % 2 === 0 ? 'md:flex-row-reverse' : ''} items-start md:items-center justify-between mb-4 gap-4`}
                                        >
                                            <div
                                            ...
                                            >
                                                ...
                                                <div
                                                    className={`inline-block px-4 py-2 ${getBlockColor(exp.blockType)} minecraft-block border-2 ${getBlockBorder(exp.blockType)}`}
                                                >
                    ...
                    <div className='mt-16 p-6 minecraft-block bg-mc-dark border-2 border-mc-border'>
                        ...
                        <div className='flex flex-wrap justify-center gap-4'>
                            {[
                                ...
                                >
                                    <div
                                        className={`w-6 h-6 ${getBlockColor(item.type)} minecraft-block border-2 ${getBlockBorder(item.type)}`}
                                    ></div>
