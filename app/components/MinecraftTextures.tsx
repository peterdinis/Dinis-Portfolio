...
export function createMinecraftTexture(baseColor: string, pattern: 'grass' | 'dirt' | 'stone' | 'wood' | 'diamond' | 'gold'): THREE.Texture {
...
export function createMinecraftBlockTextures(pattern: 'grass' | 'dirt' | 'stone' | 'wood' | 'diamond' | 'gold'): THREE.Texture[] {
  ...
  if (pattern === 'grass') {
    ...
    const baseColor = pattern === 'dirt' ? '#8B6F47' :
                     pattern === 'stone' ? '#9E9E9E' :
                     pattern === 'wood' ? '#8D6E63' :
                     pattern === 'diamond' ? '#00BCD4' :
                     pattern === 'gold' ? '#FFC107' : '#000000';
