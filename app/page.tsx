...
const Achivments = dynamic(() => import('../components/home/Achivments'), { ssr: false });
...
const TimelineWrapper = dynamic(() => import('../components/timeline/TimelineWrapper').then(mod => ({ default: mod.TimelineWrapper })), { ssr: false });
const Contact = dynamic(() => import('../components/contacts/Contact'), { ssr: false });
